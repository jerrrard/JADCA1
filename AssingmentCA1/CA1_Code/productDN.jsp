...
try {
  ...
  // Step 4: Create Statement object
   ...
   String sqlStr = "SELECT * FROM tours JOIN region JOIN category ON tours.region_id = region.region_id AND tours.category_id = category.category_id ORDER BY (curdate() - tourStart) DESC; "; 

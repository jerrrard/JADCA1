...
try {
    ...
    PreparedStatement pstmt = conn.prepareStatement("DELETE FROM CART WHERE cart_id = ?");
...
try {
 ...
 // Step 5: Execute SQL Command
    String sqlStr = "SELECT btn_id, cart_ID, itemName, itemURl, itemPrice, quantity, (itemPrice*quantity) AS Subtotal FROM cart";         

...
try {
  ...
  // Step 4: Create Statement object
   ...
   String sqlStr = "SELECT * FROM tours JOIN region JOIN ca1_product.category ON tours.region_id = region.region_id AND tours.category_id = category.category_id ORDER BY (curdate() - tourStart) ASC; "; 

...
try {
  ...
  // Step 4: Create Statement object
   ...
   PreparedStatement pstmt =conn.prepareStatement( "SELECT * FROM ca1_product.tours JOIN ca1_product.region JOIN ca1_product.category ON tours.region_id = region.region_id AND tours.category_id = category.category_id WHERE category_name = ?; "); 
   String sqlStr2 = "SELECT COUNT(product_name) FROM tours";
   pstmt.setString(1, cCategory);
